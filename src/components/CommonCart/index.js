            ...
            <div className="px-4 py-6 sm:px-8 sm:py-10 ">
              <div className=" flow-root">
                {cartItems && cartItems.length ? (
                          ...
                          <div className=" sm:col-gap-5 sm:grid sm:grid-cols-2">
                            ...
                            <div className=" mt-4 flex gap-3 items-end justify-between sm:mt-0 sm:items-start sm:justify-end">
                              ...
                              <button
                                ...
                                onClick={() =>
                                  handleDeleteCartItem(cartItems._id)
                                }
                              >
                                {componentLevelLoader &&
                  ...
                  <h1 className=" font-extrabold text-red-500 text-lg ">
                    Your cart is empty..!
                  </h1>
                )}
              </div>
              ...
              <div className=" mt-6 border-t border-b py-2">
                ...
                {/* shipping */}
                <div className=" flex items-center justify-between">
                  <p className=" text-smn text-gray-400">Shipping</p>
                  <p className="text-lg   text-black  font-semibold">$0</p>
                </div>

                <div className=" flex items-center justify-between">
                  <p className=" text-smn text-gray-400">Total</p>
                  <p className="text-lg   text-black  font-semibold">
                    ${" "}
                    {cartItems && cartItems.length
                      ? cartItems.reduce(
