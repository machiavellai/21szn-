...
export default function AdminView() {
  ...
  async function handleUpdateOrderStatus(getItem) {
    ...
    const response = await updateStatusOfOrder({
      ...getItem,
      isProcessing: false,
    });
                    ...
                    >
                      ...
                      <div className=" flex gap-5">
                        ...
                        <button
                          ...
                          className=" disabled:opacity-50 mt-5 mr-5 inline-block bg-black text-white px-5 py-3 text-xs font-medium uppercase rounded-md  tracking-wide"
                        >
                          {componentLevelLoader &&
